...
const EnrollmentForm = ({ open, onOpenChange }: EnrollmentFormProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.privacyConsent) {
      setError("Please provide consent to process your personal data under our Privacy Policy");
      return;
    }
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="md:col-span-2">
                <DpdpConsentFields
                  ...
                  privacyConsent={formData.privacyConsent}
                  marketingConsent={formData.marketingConsent}
                  onPrivacyChange={(checked) => handleChange("privacyConsent", checked)}
                  onMarketingChange={(checked) => handleChange("marketingConsent", checked)}
                />
              </div>

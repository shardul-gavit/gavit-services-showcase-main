          ...
          <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-white/70">
                ...
                <li>
                  <Link to="/erp-development" className="hover:text-white transition">
                    ERP Development
                  </Link>
                </li>
                <li>
                  <Link to="/ai-software" className="hover:text-white transition">
                    AI Software
                  </Link>
                </li>
                <li>
                  <Link to="/gst-billing-software" className="hover:text-white transition">
                    GST Billing Software
                  </Link>
                </li>
                <li>
                  <Link to="/custom-billing-software" className="hover:text-white transition">
                    Custom Billing Software
                  </Link>
                </li>
              </ul>
              <h4 className="font-semibold mb-4 mt-6 text-white">Countries</h4>
              <ul className="space-y-3 text-sm text-white/70">
                <li><Link to="/locations/usa" className="hover:text-white transition">USA</Link></li>
                <li><Link to="/locations/uk" className="hover:text-white transition">UK</Link></li>
                <li><Link to="/locations/canada" className="hover:text-white transition">Canada</Link></li>
                <li><Link to="/locations/new-zealand" className="hover:text-white transition">New Zealand</Link></li>
                <li><Link to="/locations/australia" className="hover:text-white transition">Australia</Link></li>
                <li><Link to="/locations/vadodara" className="hover:text-white transition">India</Link></li>
              </ul>
            </div>
            <div className="space-y-4">

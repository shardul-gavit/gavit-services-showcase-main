          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground mb-4">
                Explore current job openings and internship opportunities across IT services, development, and staffing roles.
              </p>
              <Button variant="outline" className="w-full" asChild>
                <Link to="/career/apply">
                  View Openings & Internships <ArrowRight className="ml-2 h-4 w-4" />
                </Link>
              </Button>
            </CardContent>
          </Card>
